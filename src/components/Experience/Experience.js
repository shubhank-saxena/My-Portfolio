            ...
            <div className="card-content">
                ...
                <div className="col s12 m10">
                    ...
                    <span className="card-title"
                        ...
                        className="teal-text hoverline">IIIT Allahabad</a>
                        </span>
                    </p>
                </div>
                </div>
                ...
                <em className="grey-text">
                    Research Intern in Center of Cognitive Computing under Dr.Pritish Varadwaj</em>
                </p>
                <ul>
                <li>
                    Development of fruit ripeness multi-class classification system, which included
                    the collection of data as well as it's training. The data collection was non-invasive in nature.
                </li>
                <li>
                    Collected and curated biological dataset showing relation between various chemical compounds
                    and their percieced smell.
                </li>
                </ul>
            </div>
