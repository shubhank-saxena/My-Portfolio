        ...
        <div class="col s12 m6">
          <div class="card">
            <div class="card-content">
              ...
              <ul>
                <li>B.E. in Electronics and Communication Engineering (2017-2021)</li>
        ...
        <div class="col s12 m6">
          <div class="card">
            <div class="card-content">
              <p>
                <span class="card-title"
                  ><a href="https://jaipuria.edu.in/ghaziabadschool/" class="teal-text hoverline"
                    >Seth Anandram Jaipuria School</a
                  ></span
                >
              </p>
